...
$\ds m_k = \frac{1}{n} \sum_{i=1}^n X_i^k$. Note that $m_1 = \bar X$  and  $\ds \tilde{S}^ 2 := m_2 - m_1^2 = \sum_{i=1}^n (X_i - \bar X)^2$.
...
- Often maximizing  $\log L(\theta \mid \vec x)$ is easier than maximizing $L(\theta \mid \vec x)$.
